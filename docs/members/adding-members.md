...
3. Fill in your member data in the template
4. Upload the completed CSV file
5. Preview the import and resolve any flagged errors
...
1. Open their profile by clicking their name in the directory
...
1. Add them as a new member with status **New Convert**
2. Record their **salvation date** in the profile
3. Assign them to a **follow-up group** or assign a **pastor/mentor**
4. Track their discipleship journey through attendance and pastoral notes

## Next Steps

- [Set up groups and cells for your members](/docs/groups/overview)
- [Track attendance](/docs/attendance/tracking)
